...
public class DataStorage {
    ...
    public static void initUserFeedsIfEmpty() {
        ...
        // mirna_dev
        ArrayList<ModelPost> mirnaFeed = new ArrayList<>();
        mirnaFeed.add(new ModelPost("mirna_dev", "Mirna Developer", R.drawable.foto_profil3, R.drawable.hl8, "Slicing UI di Android Studio 📱"));
        mirnaFeed.add(new ModelPost("mirna_dev", "Mirna Developer", R.drawable.foto_profil3, R.drawable.hl9, "Debug is my daily routine 🐛"));
        mirnaFeed.add(new ModelPost("mirna_dev", "Mirna Developer", R.drawable.foto_profil3, R.drawable.hl10, "Dark mode developer life 🌙"));
        mirnaFeed.add(new ModelPost("mirna_dev", "Mirna Developer", R.drawable.foto_profil3, R.drawable.hl11, "Git commit, push, repeat 🔁"));
        mirnaFeed.add(new ModelPost("mirna_dev", "Mirna Developer", R.drawable.foto_profil3, R.drawable.hl12, "Weekend coding session ☕💻"));
        userFeedMap.put("mirna_dev", mirnaFeed);
