...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isOwnProfile = (username == null || username.equals("myrna_"));
        ...
        if (tvToolbarName != null)
            tvToolbarName.setText(isOwnProfile ? "myrna_" : username);

        // ── Nama lengkap ──────────────────────────────────────────────────────
        TextView tvFullName = findViewById(R.id.tv_full_name);
        if (tvFullName != null)
            tvFullName.setText(isOwnProfile ? "mirna febriasari"
